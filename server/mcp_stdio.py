        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "content_type": {"type": "string", "enum": ["source", "test", "release", "issue", "pr", "wiki", "faq"], "description": "Optionally restrict to one content type: 'source' (production code), 'test' (test code — what a component actually checks), 'release', 'issue', 'pr', 'wiki', 'faq'"},
                },
                "required": ["question"],
            },
        ),
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "content_type": {"type": "string", "enum": ["faq", "wiki", "source", "test", "release", "issue", "pr"], "description": "Optionally restrict retrieval to a content type"},
                },
                "required": ["question"],
            },
        ),
